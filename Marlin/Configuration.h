...
#define STRING_CONFIG_H_AUTHOR "(Spike)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Spike's V1.1.9"
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -16.07  // Z offset: -below +above  [the nozzle]
